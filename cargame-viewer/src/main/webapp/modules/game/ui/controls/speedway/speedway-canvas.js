...
function SpeedwayCanvas(canvas) {
	 ...
	 * 
	 */
	this.createWorld = function createWorld() {
	 ...
	 */
	this.createBox = function createBox(world, x, y, width, height, options) {
		// default setting
		options = $.extend(true, {
			'density' : 1.0,
			'friction' : 0.0,
	 ...
	 * 
	 */
	this.create_car = function create_car() {
	 ...
	 */
	this.update_car = function update_car() {
	 ...
	 */
	this.redraw_world = function redraw_world(world) {
	 ...
	 * looped , game_loop
	 */
	this.game_loop = function game_loop() {
		var fps = 60;
